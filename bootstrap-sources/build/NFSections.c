...
#define _OMC_LIT29_data "/projects/OpenModelica-session2/OMCompiler/Compiler/NFFrontEnd/NFSections.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT29,76,_OMC_LIT29_data);
