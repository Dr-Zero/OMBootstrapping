...
#define _OMC_LIT1_data "/projects/OpenModelica-session2/OMCompiler/Compiler/NFFrontEnd/NFRangeIterator.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT1,81,_OMC_LIT1_data);
