...
#define _OMC_LIT28_data "/projects/OpenModelica-session2/OMCompiler/Compiler/BackEnd/BackendVarTransform.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT28,82,_OMC_LIT28_data);
