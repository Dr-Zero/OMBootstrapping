...
#define _OMC_LIT5_data "NBPartition.Partition.merge failed. Should not merge partitions with adjacency matrix."
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT5,86,_OMC_LIT5_data);
#define _OMC_LIT5 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT5)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT6,2,1) {_OMC_LIT5,MMC_REFSTRUCTLIT(mmc_nil)}};
#define _OMC_LIT6 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT6)
#define _OMC_LIT7_data "NBPartition.Partition.merge failed. Should not merge matched partitions."
...
#define _OMC_LIT9_data "NBPartition.Partition.merge failed. Should not merge sorted partitions."
...
#define _OMC_LIT11_data "NBPartition.Partition.merge failed. Cannot merge DAE-Mode partitions."
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT11,69,_OMC_LIT11_data);
#define _OMC_LIT11 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT11)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT12,2,1) {_OMC_LIT11,MMC_REFSTRUCTLIT(mmc_nil)}};
#define _OMC_LIT12 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT12)
#define _OMC_LIT13_data "NBPartition.Partition.kindToInteger failed. Unknown partition kind in match."
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT13,76,_OMC_LIT13_data);
...
#define _OMC_LIT27_data "NBPartition.Partition.getClocks failed. Cannot get clock for continuous partition:\n"
...
#define _OMC_LIT31_data " Partition"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT31,10,_OMC_LIT31_data);
#define _OMC_LIT31 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT31)
#define _OMC_LIT32_data "Unknown"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT32,7,_OMC_LIT32_data);
#define _OMC_LIT32 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT32)
#define _OMC_LIT33_data "/home/per/workspace/OpenModelica/OMCompiler/Compiler/NBackEnd/Classes/NBPartition.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT33,84,_OMC_LIT33_data);
#define _OMC_LIT33 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT33)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT34_6,1.771250266e9);
#define _OMC_LIT34_6 MMC_REFREALLIT(_OMC_LIT_STRUCT34_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT34,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(250)),MMC_IMMEDIATE(MMC_TAGFIXNUM(13)),MMC_IMMEDIATE(MMC_TAGFIXNUM(250)),MMC_IMMEDIATE(MMC_TAGFIXNUM(93)),_OMC_LIT34_6}};
#define _OMC_LIT34 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT34)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT35_6,1.771250266e9);
#define _OMC_LIT35_6 MMC_REFREALLIT(_OMC_LIT_STRUCT35_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT35,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(248)),MMC_IMMEDIATE(MMC_TAGFIXNUM(13)),MMC_IMMEDIATE(MMC_TAGFIXNUM(248)),MMC_IMMEDIATE(MMC_TAGFIXNUM(93)),_OMC_LIT35_6}};
#define _OMC_LIT35 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT35)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT36_6,1.771250266e9);
#define _OMC_LIT36_6 MMC_REFREALLIT(_OMC_LIT_STRUCT36_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT36,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(246)),MMC_IMMEDIATE(MMC_TAGFIXNUM(14)),MMC_IMMEDIATE(MMC_TAGFIXNUM(246)),MMC_IMMEDIATE(MMC_TAGFIXNUM(32)),_OMC_LIT36_6}};
#define _OMC_LIT36 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT36)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT37_6,1.771250266e9);
#define _OMC_LIT37_6 MMC_REFREALLIT(_OMC_LIT_STRUCT37_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT37,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(294)),MMC_IMMEDIATE(MMC_TAGFIXNUM(13)),MMC_IMMEDIATE(MMC_TAGFIXNUM(294)),MMC_IMMEDIATE(MMC_TAGFIXNUM(98)),_OMC_LIT37_6}};
...
#define _OMC_LIT40_data "NBPartition.Association.merge failed. Cannot merge "
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT40,51,_OMC_LIT40_data);
#define _OMC_LIT40 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT40)
#define _OMC_LIT41_data " and "
...
#define _OMC_LIT43_data "NBPartition.Association.create failed because there are non-identical clocks in the same partition:\n### First clock found:\n"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT43,123,_OMC_LIT43_data);
#define _OMC_LIT43 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT43)
#define _OMC_LIT44_data "\n### Conflicting clocks:\n"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT44,25,_OMC_LIT44_data);
#define _OMC_LIT44 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT44)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT45_6,1.771250266e9);
#define _OMC_LIT45_6 MMC_REFREALLIT(_OMC_LIT_STRUCT45_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT45,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(163)),MMC_IMMEDIATE(MMC_TAGFIXNUM(11)),MMC_IMMEDIATE(MMC_TAGFIXNUM(163)),MMC_IMMEDIATE(MMC_TAGFIXNUM(80)),_OMC_LIT45_6}};
#define _OMC_LIT45 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT45)
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT46_6,1.771250266e9);
#define _OMC_LIT46_6 MMC_REFREALLIT(_OMC_LIT_STRUCT46_6)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT46,8,3) {&SourceInfo_SOURCEINFO__desc,_OMC_LIT33,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */)),MMC_IMMEDIATE(MMC_TAGFIXNUM(164)),MMC_IMMEDIATE(MMC_TAGFIXNUM(11)),MMC_IMMEDIATE(MMC_TAGFIXNUM(164)),MMC_IMMEDIATE(MMC_TAGFIXNUM(129)),_OMC_LIT46_6}};
#define _OMC_LIT46 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT46)
#define _OMC_LIT47_data "No Jacobian"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT47,11,_OMC_LIT47_data);
#define _OMC_LIT47 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT47)
#define _OMC_LIT48_data "moo"
...
#define _OMC_LIT51_data "Generate code for dynamic optimization library MOO."
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT53,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(163)),_OMC_LIT48,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT49,_OMC_LIT50,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT52}};
#define _OMC_LIT53 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT53)
#define _OMC_LIT54_data " Adjoint"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT54,8,_OMC_LIT54_data);
#define _OMC_LIT54 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT54)
#define _OMC_LIT55_data "Base clock: "
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT55,12,_OMC_LIT55_data);
#define _OMC_LIT55 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT55)
#define _OMC_LIT56_data "Sub clock: "
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT56,11,_OMC_LIT56_data);
#define _OMC_LIT56 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT56)
#define _OMC_LIT57_data " of base clock "
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT57,15,_OMC_LIT57_data);
#define _OMC_LIT57 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT57)
#define _OMC_LIT58_data "NBPartition.Association.toString failed. Unknown partition association in match."
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT58,80,_OMC_LIT58_data);
...
#define _OMC_LIT61_data "Clocked"
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NBPartition_Association_expClocked(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fexp, modelica_metatype _info, modelica_metatype _clock_ptr, modelica_metatype _failed_set, modelica_metatype _clock_deps);
...
modelica_metatype omc_NBPartition_Partition_merge(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fpart1, modelica_metatype _part2, modelica_boolean _strict)
{
  ...
  {
    omc_Error_addMessage(threadData, _OMC_LIT4, _OMC_LIT12);
  ...
  memcpy(MMC_UNTAGPTR(tmpMeta1), MMC_UNTAGPTR(_part1), 10*sizeof(modelica_metatype));
  ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta1))[3] = omc_NBPartition_Association_merge(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part1), 3))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part2), 3))), _strict);
  _part1 = tmpMeta1;

  tmpMeta2 = MMC_TAGPTR(mmc_alloc_words(10));
  memcpy(MMC_UNTAGPTR(tmpMeta2), MMC_UNTAGPTR(_part1), 10*sizeof(modelica_metatype));
  ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta2))[4] = omc_NBVariable_VariablePointers_addList(threadData, omc_NBVariable_VariablePointers_toList(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part2), 4)))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part1), 4))));
  _part1 = tmpMeta2;

  tmpMeta3 = MMC_TAGPTR(mmc_alloc_words(10));
  memcpy(MMC_UNTAGPTR(tmpMeta3), MMC_UNTAGPTR(_part1), 10*sizeof(modelica_metatype));
  ((modelica_metatype*)MMC_UNTAGPTR(tmpMeta3))[6] = omc_NBEquation_EquationPointers_addList(threadData, omc_NBEquation_EquationPointers_toList(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part2), 6)))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part1), 6))));
  _part1 = tmpMeta3;
      ...
      tmp9_1 = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_par), 3)));
      {
        ...
        for (; tmp9 < 2; tmp9++) {
          ...
          case 0: {
            ...
            memcpy(MMC_UNTAGPTR(tmpMeta11), MMC_UNTAGPTR(_association), 8*sizeof(modelica_metatype));
    ...
    tmp4_1 = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_part), 3)));
    {
      ...
      for (; tmp4 < 2; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmpMeta11 = stringAppend(_OMC_LIT27,omc_NBPartition_Partition_toString(threadData, _part, ((modelica_integer) 0)));
...
modelica_string omc_NBPartition_Partition_toStringList(threadData_t *threadData, modelica_metatype _partitions, modelica_string _header)
{
  ...
  {
    if((!stringEqual(_header, _OMC_LIT15)))
    {
      tmpMeta1 = stringAppend(omc_StringUtil_headline__1(threadData, _header),_OMC_LIT28);
      _str = tmpMeta1;
    }
...
modelica_string omc_NBPartition_Partition_toString(threadData_t *threadData, modelica_metatype _partition, modelica_integer _level)
{
  ...
  tmpMeta1 = stringAppend(_OMC_LIT29,intString(mmc_unbox_integer((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 2))))));
  ...
  tmpMeta5 = stringAppend(omc_StringUtil_headline__2(threadData, tmpMeta4),_OMC_LIT28);
  _str = tmpMeta5;
    ...
    tmp9_1 = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 9)));
    {
      ...
      for (; tmp9 < 2; tmp9++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          tmpMeta17 = stringAppend(_str,omc_NBVariable_VariablePointers_toString(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 4))), _OMC_LIT32, mmc_mk_none(), 1 /* true */));
          tmpMeta18 = stringAppend(tmpMeta17,_OMC_LIT28);
          tmpMeta19 = stringAppend(tmpMeta18,omc_NBEquation_EquationPointers_toString(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 6))), _OMC_LIT15, mmc_mk_none(), 1 /* true */, mmc_mk_none()));
  ...
  if(((_level == ((modelica_integer) 1)) || (_level == ((modelica_integer) 3))))
  {
    ...
    {
      tmpMeta21 = stringAppend(_str,omc_NBAdjacency_Matrix_toString(threadData, omc_Util_getOption(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 7)))), _OMC_LIT15));
    ...
    {
      tmpMeta23 = stringAppend(_str,omc_NBMatching_toString(threadData, omc_Util_getOption(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_partition), 8)))), _OMC_LIT15));
      tmpMeta24 = stringAppend(tmpMeta23,_OMC_LIT28);
      _str = tmpMeta24;
    }
  }
  ...
  if((_level == ((modelica_integer) 2)))
  {
    ...
    tmpMeta26 = stringAppend(tmpMeta25,_OMC_LIT28);
    _str = tmpMeta26;
  }
  _return: OMC_LABEL_UNUSED
  return _str;
...
static modelica_metatype closure1_NBPartition_Association_expClocked(threadData_t *thData, modelica_metatype closure, modelica_metatype $in_exp)
{
  ...
  modelica_metatype failed_set = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),3));
  modelica_metatype clock_deps = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),4));
  return boxptr_NBPartition_Association_expClocked(thData, $in_exp, info, clock_ptr, failed_set, clock_deps);
}
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NBPartition_Association_expClocked(threadData_t *threadData, modelica_metatype __omcQ_24in_5Fexp, modelica_metatype _info, modelica_metatype _clock_ptr, modelica_metatype _failed_set, modelica_metatype _clock_deps)
{
    ...
    tmp4_1 = _exp;
    {
      ...
      for (; tmp4 < 3; tmp4++) {
        ...
        case 0: {
          ...
          if (!omc_NBVariable_isClockOrClocked(threadData, omc_NBVariable_getVarPointer(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), _OMC_LIT36))) goto tmp3_end;
          ...
          {
            _clock_opt = mmc_mk_some(omc_UnorderedMap_getSafe(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_info), 2))), _OMC_LIT35));
          }
          else
          {
            ...
            {
              _clock_opt = mmc_mk_some(omc_UnorderedMap_getSafe(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_info), 3))), _OMC_LIT34));
            }
            else
            {
            ...
            tmp8_2 = omc_Pointer_access(threadData, _clock_ptr);
            {
              ...
              for (; tmp8 < 7; tmp8++) {
                ...
                case 0: {
                  ...
                  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta12,1,3) == 0) goto tmp7_end;
                ...
                case 1: {
                  ...
                  if (optionNone(tmp8_2)) goto tmp7_end;
                  tmpMeta14 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_2), 1));
                  tmpMeta15 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta14), 2));
                  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta15,0,1) == 0) goto tmp7_end;
                  
                  _new = tmpMeta13;
                  /* Pattern matching succeeded */
                  tmpMeta16 = mmc_mk_box2(0, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), _new);
                  omc_Pointer_update(threadData, _clock_ptr, mmc_mk_some(tmpMeta16));
                  goto tmp7_done;
                }
                case 2: {
                  modelica_metatype tmpMeta17;
                  modelica_metatype tmpMeta18;
                  if (optionNone(tmp8_1)) goto tmp7_end;
                  tmpMeta17 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_1), 1));
                  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta17,0,1) == 0) goto tmp7_end;
                  tmpMeta18 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta17), 2));
                  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta18,0,0) == 0) goto tmp7_end;
                ...
                case 3: {
                  ...
                  modelica_metatype tmpMeta23;
                  if (optionNone(tmp8_1)) goto tmp7_end;
                  tmpMeta19 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_1), 1));
                  if (optionNone(tmp8_2)) goto tmp7_end;
                  tmpMeta20 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_2), 1));
                  ...
                  if (mmc__uniontype__metarecord__typedef__equal(tmpMeta22,0,0) == 0) goto tmp7_end;
                  _new = tmpMeta19;
                  /* Pattern matching succeeded */
                  tmpMeta23 = mmc_mk_box2(0, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), _new);
                  omc_Pointer_update(threadData, _clock_ptr, mmc_mk_some(tmpMeta23));
                  goto tmp7_done;
                }
                case 4: {
                  modelica_metatype tmpMeta24;
                  ...
                  if (optionNone(tmp8_1)) goto tmp7_end;
                  tmpMeta24 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_1), 1));
                  if (optionNone(tmp8_2)) goto tmp7_end;
                  tmpMeta25 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp8_2), 1));
                  tmpMeta26 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta25), 2));
                  _new = tmpMeta24;
                  _old = tmpMeta26;
                  /* Pattern matching succeeded */
                  if((!omc_NBPartitioning_BClock_isEqual(threadData, _new, _old)))
                  {
        ...
        case 1: {
          ...
          {
            omc_UnorderedSet_add(threadData, omc_UnorderedMap_getSafe(threadData, _arg, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_info), 3))), _OMC_LIT37), _clock_deps);
          }
          tmpMeta1 = _exp;
          goto tmp3_done;
        }
        case 2: {
          ...
          /* Pattern matching succeeded */
          tmpMeta35 = mmc_mk_box4(0, _info, _clock_ptr, _failed_set, _clock_deps);
...
modelica_integer omc_NBPartition_Association_hashClockTpl(threadData_t *threadData, modelica_metatype _tpl)
{
  ...
  _hash = stringHashDjb2Continue(omc_NFComponentRef_toString(threadData, omc_Util_tuple21(threadData, _tpl)), _hash);
...
modelica_string omc_NBPartition_Association_clockTplString(threadData_t *threadData, modelica_metatype _tpl)
{
  ...
  MMC_SO();
  _tailrecursive: OMC_LABEL_UNUSED
  tmpMeta1 = stringAppend(_OMC_LIT29,omc_NFComponentRef_toString(threadData, omc_Util_tuple21(threadData, _tpl)));
  tmpMeta2 = stringAppend(tmpMeta1,_OMC_LIT38);
  tmpMeta3 = stringAppend(tmpMeta2,omc_NBPartitioning_BClock_toString(threadData, omc_Util_tuple22(threadData, _tpl)));
  tmpMeta4 = stringAppend(tmpMeta3,_OMC_LIT39);
  _str = tmpMeta4;
  _return: OMC_LABEL_UNUSED
  return _str;
}
    ...
    tmp4_2 = _ass2;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta15 = stringAppend(_OMC_LIT40,omc_NBPartition_Association_toString(threadData, _ass1));
...
modelica_metatype omc_NBPartition_Association_create(threadData_t *threadData, modelica_metatype _equations, modelica_integer _kind, modelica_metatype _info)
{
  ...
  // _clock has no default value.
  tmpMeta1 = mmc_mk_box4(0, _info, _clock_ptr, _failed_set, _clock_deps);
  ...
  if(isSome(_clock_tpl))
  {
    ...
    if((!omc_UnorderedSet_isEmpty(threadData, _failed_set)))
    {
      ...
      tmpMeta8 = stringAppend(_OMC_LIT43,omc_NBPartition_Association_clockTplString(threadData, tmpMeta7));
      tmpMeta9 = stringAppend(tmpMeta8,_OMC_LIT44);
      tmpMeta10 = stringAppend(tmpMeta9,omc_UnorderedSet_toString(threadData, _failed_set, boxvar_NBPartition_Association_clockTplString, _OMC_LIT28));
    ...
    {
      tmpMeta12 = mmc_mk_box5(4, &NBPartition_Association_CLOCKED__desc, _clock, mmc_mk_none(), _clock_deps, mmc_mk_boolean(0 /* false */));
      _association = tmpMeta12;
    }
    else
    {
      _base_name = omc_UnorderedMap_getSafe(threadData, _name, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_info), 4))), _OMC_LIT45);

      tmpMeta13 = mmc_mk_box5(4, &NBPartition_Association_CLOCKED__desc, _clock, mmc_mk_some(omc_UnorderedMap_getSafe(threadData, _base_name, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_info), 2))), _OMC_LIT46)), _clock_deps, mmc_mk_boolean(0 /* false */));
      _association = tmpMeta13;
    }
  }
  else
  {
    tmpMeta14 = mmc_mk_box7(3, &NBPartition_Association_CONTINUOUS__desc, mmc_mk_integer((modelica_integer)_kind), mmc_mk_none(), mmc_mk_none(), mmc_mk_none(), mmc_mk_none(), mmc_mk_none());
    _association = tmpMeta14;
  }
  _return: OMC_LABEL_UNUSED
  return _association;
      ...
      int tmp4;
      {
        ...
        case 3: {
          ...
          if(isSome((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 3)))))
          {
            ...
            {
              tmpMeta5 = stringAppend(_OMC_LIT28,_str);
              ...
              tmpMeta7 = stringAppend(_OMC_LIT28,_str);
              ...
              tmpMeta9 = stringAppend(_OMC_LIT28,_str);
          ...
          {
            _str = omc_StringUtil_headline__1(threadData, _OMC_LIT47);
          }

          if(isSome((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 4)))))
          {
            tmpMeta11 = stringAppend(omc_NBPartition_Partition_kindToString(threadData, mmc_unbox_integer((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 2))))),_OMC_LIT54);
            tmpMeta12 = stringAppend(omc_NBJacobian_toString(threadData, omc_Util_getOption(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 4)))), tmpMeta11),_OMC_LIT28);
            _str = tmpMeta12;
          }
          tmp1 = _str;
          goto tmp3_done;
        ...
        case 4: {
          ...
          if(isSome((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 3)))))
          {
            tmpMeta13 = stringAppend(_OMC_LIT56,_str);
          ...
          {
            tmpMeta16 = stringAppend(_OMC_LIT55,_str);
        ...
        tmp3_default: OMC_LABEL_UNUSED; {
          ...
          /* Pattern matching succeeded */
          omc_Error_addMessage(threadData, _OMC_LIT4, _OMC_LIT59);
          goto goto_2;
          goto tmp3_done;
        }
        }
    ...
    tmp4_1 = _association;
    {
      int tmp4;
      {
        ...
        case 3: {
          ...
          /* Pattern matching succeeded */
          tmpMeta5 = stringAppend(_OMC_LIT60,omc_NBPartition_Partition_kindToString(threadData, mmc_unbox_integer((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_association), 2))))));
          tmp1 = tmpMeta5;
          goto tmp3_done;
        }
        case 4: {
