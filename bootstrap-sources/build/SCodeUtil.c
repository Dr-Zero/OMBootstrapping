...
#define _OMC_LIT46_data "/projects/OpenModelica-session2/OMCompiler/Compiler/FrontEnd/SCodeUtil.mo"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT46,73,_OMC_LIT46_data);
